...
public class ManagerService {
    ...
    public ManagerSaveResponse saveManager(AuthUser authUser, long todoId, ManagerSaveRequest managerSaveRequest) {
        ...
        try {
            ...
            // 성공 로그 저장
            logService.saveLog("매니저 등록 성공", request.getRequestURI(), user.getId(), managerUser.getId(), todoId);
            ...
            // 실패 로그 저장
            logService.saveLog("매니저 등록 실패: " + e.getMessage(), request.getRequestURI(), authUser.getId(), managerSaveRequest.getManagerUserId(), todoId);
            throw e;
        }
    }
